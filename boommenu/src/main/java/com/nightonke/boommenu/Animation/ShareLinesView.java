...
public class ShareLinesView extends View {
    ...
    public void setData(ArrayList<RectF> piecePositions, BoomMenuButton bmb) {
        ...
        long animationShowDelay3 = bmb.getShowDelay() * (pieceNumbers[2] - 1 + pieceNumbers[1] + pieceNumbers[0]) + bmb.getShowDuration();
        ...
        long animationHideDelay3 = bmb.getHideDelay() * (pieceNumbers[2] - 1 + pieceNumbers[1] + pieceNumbers[0]) + bmb.getHideDuration();
